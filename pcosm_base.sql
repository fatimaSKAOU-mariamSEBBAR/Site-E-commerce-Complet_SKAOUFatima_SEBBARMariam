...
INSERT INTO `comment` (`email`, `comment`, `id_comment`) VALUES
('crasy.meryam@gmail.com', 'hello im maryam la qualite est bonne', 1),
('sebbar.mohamed66@gmail.com', 'La Commission s’assure de faire connaître sa politique à son personnel et à sa\r\nclientèle.', 3),
('abcdef@gmail.com', 'Le client peut exprimer sa plainte ou son commentaire par le mode de\r\ncommunication de son choix et sa démarche est facilitée afin qu’il puisse\r\ncommuniquer en toute confiance et sans crainte de représailles;', 4),
('skaoufatima@gmail.com', 'Le traitement des plaintes s’appuie sur les lignes de conduite énoncées dans la\r\nDéclaration de services aux citoyens et dans le Code de déontologie de la\r\nCommission;', 5),
('crasy.meryam@gmail.com', 'Toutes les plaintes et les commentaires sont portés à l’attention de la personne\r\nresponsable de la gestion des plaintes et des commentaires. Pour assurer\r\nl’indépendance du mécanisme de traitement, cette personne relève directement du\r\nprésident;', 6),
('walid.kerdoun@gmail.com', 'Tous les intervenants font preuve d’ouverture envers le client dans la recherche\r\nd’une solution appropriée au problème soulevé;', 7),
('naime.00@gmail.com', 'Le personnel en contact avec la clientèle est partie prenante du processus\r\nd’amélioration de la qualité des services. ', 8),
('sobay.9@gmail.com', 'Le contact téléphonique est privilégié comme premier mode de communication. Un\r\naccusé de réception est toutefois envoyé lorsqu’il a été impossible de joindre le client\r\naprès trois tentatives;', 9);
...
(2, 'Sebbar Mariam', 'sebbar.mariam.06@gmail.com', 'Suppression de compte', 'PcosM,\r\nJe vous confirme par la présente lettre ma demande de clôture de mon compte domicilié dans votre agence \r\nJe souhaite que cette clôture prenne effet sans délai, dès reception du message.\r\nVeuillez agréer, Madame, Monsieur, l’expression de mes salutations distinguées.', '2020-04-23 02:57:00'),
(3, 'Skaou Fatima', 'skaoufatima@gmail.com', 'Déblocage de compte', 'J’ai été informé(e) par votre courrier du que mon compte a été bloqué .\r\nJ’ai cependant besoin d&#39;acheter des produits.\r\nEn espérant que vous donnerez une suite favorable à ma demande, je vous prie d’agréer, Madame, Monsieur, mes salutations distinguées.', '2020-04-23 03:15:00'),
(4, 'Kerdoun walid', 'walid.kerdoun@gmail.com', 'Ajout d&#39;un produit', 'Une copie de l’avis de conformité émis par la Direction des produits thérapeutiques (DPT) de Santé Canada pour ce produit. Pour tout produit n’ayant pas fait l’objet d’un avis de conformité, veuillez fournir le certificat d’identification numérique de la drogue (DIN) délivré par Santé Canada ainsi que toute l’information pertinente sur le processus d’homologation du produit.', '2020-04-23 03:20:00'),
(5, 'Sebbar Mohamed', 'sebbar.mohamed66@gmail.com', 'Demande d&#39;emploi', ' Je suis très intéressé par les activités de votre société ; je me permets de soumettre ma présente candidature pour un éventuel poste au sein de votre équipe.  \r\n Pour une meilleure considération de ma candidature mon C.V ci-joint dresse un état de ma formation, mes travaux et stages effectués. Un éventuel entretien me permettrait de vous étaler plus amplement mes qualités humaines et professionnelles. Dans l’attente de vous rencontrer prochainement, je vous prie de croire monsieur l’expression de mes sincères salutations                                           ', '2020-04-23 03:24:00'),
(6, 'Elmouden Said', 'elmouden.said@gmail.com', 'Probléme lié au compte', 'Pour nous assurer que Pcosm reste un espace sûr, nous examinons le contenu des publicités. Dans certains cas, nous pouvons désactiver les comptes qui ne sont pas conformes à nos règles publicitaires. Étant donné qu’il existe de nombreuses raisons pour lesquelles un compte publicitaire peut être désactivé, nous vous conseillons de lire ces règles ainsi que nos Conditions d’utilisation.', '2020-04-23 03:24:00');
...
(45, 'Skaou-Sebbar', 'hay yassamine rue 953 n44 imm 4', 707648241, 'skaou.sebbar.00@gmail.com', '1234Autre?', 'admin'),
(46, 'SKAOU Fatima', 'hay doha rue 953 nr 41 dcheira inzegane', 909090909, 'skaoufatima@gmail.com', 'eac97538e1e07d6615e0bf673ab71e33', 'client'),
(47, 'Sebbar Mohamed', 'hay doha rue 953 nr 41 dcheira inzegane', 606060706, 'sebbar.mohamed66@gmail.com', '00eb8fd9129125c031f6d1eb50fc7be7', 'client');
